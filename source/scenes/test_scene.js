...
export class TestScene extends PhysicsSim
{
    ...
    {
        // Test Scene 1.
        //this.rigidbodies.set("Sphere1", new RigidBody(this.shapes.sphere, this.materials.plastic, "Sphere1", vec4(-20, 1, 0, 1), vec4(0, 0, 0, 0), 1, vec3(2, 2, 2), "sphere", false));
        ...
        this.rigidbodies.set("Wall4", new RigidBody(this.shapes.cube, this.materials.plastic.override({color: color(1, 1, 0, 1)}), "Wall4", vec4(0, 0, -21, 1), vec4(0, 0, 0, 0), 1, vec3(20, 20, 1), "cube", true));
        this.rigidbodies.set("Ceiling", new RigidBody(this.shapes.cube, this.materials.plastic.override({color: color(1, 1, 0, 1)}), "Ceiling", vec4(0, 21, 0, 1), vec4(0, 0, 0, 0), 1, vec3(20, 1, 20), "cube", true));
        this.rigidbodies.set("Cube1", new RigidBody(this.shapes.cube, this.materials.plastic.override({ color: color(1, 0, 0, 1) }), "Cube1", vec4(0, 17.5, 0, 1), vec4(0, 0, 0, 0), 1, vec3(1, 1, 1), "cube", false));
        ...
        this.rigidbodies.set("Cube3", new RigidBody(this.shapes.cube, this.materials.plastic.override({ color: color(0, 0, 1, 1) }), "Cube3", vec4(0, 5, 0, 1), vec4(0, 0, 0, 0), 1, vec3(1, 1, 1), "cube", false));
        this.rigidbodies.set("Cube4", new RigidBody(this.shapes.cube, this.materials.plastic.override({ color: color(0, 1, 1, 1) }), "Cube4", vec4(0, 0, 0, 1), vec4(0, 0, 0, 0), 1, vec3(1, 1, 1), "cube", false));
        ...
        // Test Scene 4.
        this.rigidbodies.set("Ground", new RigidBody(this.shapes.cube, this.materials.plastic.override({color: color(1, 1, 0, 1)}), "Ground", vec4(0, -21, 0, 1), vec4(0, 0, 0, 0), 1, vec3(20, 2, 20), "cube", true));
        this.rigidbodies.set("Wall1", new RigidBody(this.shapes.cube, this.materials.plastic.override({color: color(1, 1, 0, 1)}), "Wall1", vec4(-21, 0, 0, 1), vec4(0, 0, 0, 0), 1, vec3(2, 20, 20), "cube", true));
        this.rigidbodies.set("Wall2", RigidBody.createCollider("Wall2", this.shapes.cube.arrays.position, vec4(0, 0, 20, 1), vec4(0, 0, 0, 0), 1, vec3(20, 20, 2), "cube", true));
        this.rigidbodies.set("Wall3", new RigidBody(this.shapes.cube, this.materials.plastic.override({color: color(1, 1, 0, 1)}), "Wall3", vec4(21, 0, 0, 1), vec4(0, 0, 0, 0), 1, vec3(2, 20, 20), "cube", true));
        this.rigidbodies.set("Wall4", new RigidBody(this.shapes.cube, this.materials.plastic.override({color: color(1, 1, 0, 1)}), "Wall4", vec4(0, 0, -21, 1), vec4(0, 0, 0, 0), 1, vec3(20, 20, 2), "cube", true));
        this.rigidbodies.set("Ceiling", new RigidBody(this.shapes.cube, this.materials.plastic.override({color: color(1, 1, 0, 1)}), "Ceiling", vec4(0, 21, 0, 1), vec4(0, 0, 0, 0), 1, vec3(20, 2, 20), "cube", true));
        this.rigidbodies.set("Cube1", new RigidBody(this.shapes.cube, this.materials.plastic.override({ color: color(1, 0, 0, 1) }), "Cube1", vec4(0, 17.5, 0, 1), vec4(0, 0, 0, 0), 1, vec3(1, 1, 1), "cube", false));
        this.rigidbodies.set("Cube2", new RigidBody(this.shapes.cube, this.materials.plastic.override({ color: color(0, 1, 0, 1) }), "Cube2", vec4(0, 10, 0.1, 1), vec4(0, 0, 0, 0), 1, vec3(1, 1, 1), "cube", false));
        this.rigidbodies.set("Cube3", new RigidBody(this.shapes.cube, this.materials.plastic.override({ color: color(0, 0, 1, 1) }), "Cube3", vec4(0, 5, 0, 1), vec4(0, 0, 0, 0), 1, vec3(1, 1, 1), "cube", false));
        this.rigidbodies.set("Cube4", new RigidBody(this.shapes.cube, this.materials.plastic.override({ color: color(0, 1, 1, 1) }), "Cube4", vec4(0, 0, 0, 1), vec4(0, 0, 0, 0), 1, vec3(1, 1, 1), "cube", false));
        this.rigidbodies.set("Sphere1", new RigidBody(this.shapes.sphere, this.materials.plastic.override({ color: color(0, 1, 0, 1) }), "Sphere1", vec4(5, 15, 0, 1), vec4(0, 0, 0, 0), 1, vec3(1, 1, 1), "sphere", false));
        this.rigidbodies.set("Sphere2", new RigidBody(this.shapes.sphere, this.materials.plastic.override({ color: color(0, 1, 0, 1) }), "Sphere2", vec4(-5, 4, -5, 1), vec4(0, 0, 0, 0), 1, vec3(1, 1, 1), "sphere", false));
        this.rigidbodies.set("Sphere3", new RigidBody(this.shapes.sphere, this.materials.plastic.override({ color: color(0, 1, 0, 1) }), "Sphere3", vec4(-4, 11, -6, 1), vec4(0, 0, 0, 0), 1, vec3(1, 1, 1), "sphere", false));
        this.rigidbodies.set("Sphere4", new RigidBody(this.shapes.sphere, this.materials.plastic.override({ color: color(0, 1, 0, 1) }), "Sphere4", vec4(-10, -4, 5, 1), vec4(0, 0, 0, 0), 1, vec3(1, 1, 1), "sphere", false));
        ...
        this.forces.push(new Force(["Cube1"], vec4(0.5, 0, 0.5, 0), false, 3));
        this.forces.push(new Force(["Cube2"], vec4(-0.7, 0, -1, 0), false, 5));
        this.forces.push(new Force(["Cube3"], vec4(-0.1, 0, -1, 0), false, 7));
        this.forces.push(new Force(["Cube4"], vec4(0.8, 0, -0.5, 0), false, 6));
        ...
        this.forces.push(new Force(["Sphere1"], vec4(0.3, 0.6, 0, 0), false, 3));
        this.forces.push(new Force(["Sphere2"], vec4(-0.4, 0.1, -1, 0), false, 5));
        this.forces.push(new Force(["Sphere3"], vec4(0, 0, 1, 0), false, 7));
        this.forces.push(new Force(["Sphere4"], vec4(0, -0.3, -0.5, 0), false, 6));
    }
